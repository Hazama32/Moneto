...
export default function BudgetPage() {
  ...
  async function fetchBudgets() {
    try {
      ...
      if (budgetError) {
        console.error("Error fetching budgets:", JSON.stringify(budgetError, null, 2));
        return;
      }
      ...
      <main className="flex-1 p-8">
        ...
        >
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800">Pengelolaan Tabungan</h1>
            <button
              onClick={() => {
                setShowForm(true);
                setEditingBudget(null);
          ...
          {showForm && (
            ...
            >
              <h2 className="text-xl text-black font-semibold mb-4">
                {editingBudget ? "Edit Tabungan" : "Tambah Tabungan Baru"}
              </h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    {editingBudget ? "Ubah" : "Tambah Tabungan"}
                  </button>
                  <button
                    type="button"
                    onClick={() => {
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-800">Tabungan Anda</h2>
            </div>
            <div className="divide-y divide-gray-200">
              {budgets.length === 0 ? (
                <div className="px-6 py-8 text-center text-gray-500">
                  Tidak ada tabungan yang ditemukan. Buat tabungan pertama Anda untuk memulai.
                </div>
              ) : (
                budgets.map((budget) => (
                    ...
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Target: Rp {budget.limit_amount.toLocaleString("id-ID")}
                        </p>
